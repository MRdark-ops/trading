...
import { TrendingUp, Users as UsersIcon, DollarSign, Zap, Wallet, ArrowUpRight } from 'lucide-react';
...
function Dashboard() {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      console.log('✅ Dashboard data received:', { overviewRes, growthRes, referrersRes });
      ...
      <div className="metrics-grid">
        <div className="metric-card">
          ...
          <div className="metric-content">
            ...
            <p className="metric-subtext">+{overview?.activeUsers || 0} Active</p>
          </div>
        </div>
        ...
        <div className="metric-card">
          ...
          <div className="metric-content">
            ...
            <h3 className="metric-value">${(overview?.totalRevenue || 0).toFixed(2)}</h3>
            <p className="metric-subtext">From {overview?.totalPaidSubscriptions || 0} payments</p>
          </div>
        </div>
        ...
        <div className="metric-card">
          ...
          <div className="metric-content">
            ...
            <h3 className="metric-value">{(overview?.externalMembers || 0) + (overview?.internalMembers || 0)}</h3>
            <p className="metric-subtext">External: {overview?.externalMembers || 0} | Internal: {overview?.internalMembers || 0}</p>
          </div>
        </div>
        ...
        <div className="metric-card">
          ...
          <div className="metric-content">
            ...
            <h3 className="metric-value">${(overview?.totalReferralCommissionsPaid || 0).toFixed(2)}</h3>
        ...
        <div className="metric-card">
          ...
          <div className="metric-content">
            ...
            <h3 className="metric-value">{overview?.pendingWithdrawals || 0}</h3>
            ...
            {topReferrers.slice(0, 10).map((referrer, idx) => (
              <div key={idx} className="referrer-item">
                ...
                <div className="referrer-info">
                  <p className="referrer-name">{referrer.referrer?.fullName || referrer.referrer?.email}</p>
                  <p className="referrer-stats">{referrer.totalReferrals} referrals</p>
                </div>
                <div className="referrer-conversion">
                  <span className="conversion-rate">{referrer.conversionRate}</span>
                </div>
              </div>
            ))}
          </div>
