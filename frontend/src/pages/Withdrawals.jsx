...
function Withdrawals () {
  ...
  const fetchWithdrawals = async () => {
    try {
      ...
      const total = res.data.withdrawals.reduce(
              ...
              <div key={withdrawal.id} className='table-row'>
                <div className='col-user'>
                  <div className='user-name'>
                    {withdrawal.User?.fullName || 'Unknown'}
                  </div>
                ...
                <div className='col-status'>
                  <span
                    className={`status-badge ${withdrawal.status.toLowerCase()}`}
                  >
                    {withdrawal.status}
                  </span>
                </div>
                <div className='col-actions'>
                  <select
                    ...
                    onChange={(e) =>
                      handleStatusUpdate(withdrawal.id, e.target.value)}
