    ...
    <div className='legal-page'>
      ...
      <div className='legal-content'>
        <section>
          ...
          <p>
            Trading DZ ("we", "us", "our", or "Company") operates the
            www.tradingdz.com website (the "Service"). This page informs you of
        ...
        <section>
          ...
          <ul>
            ...
            <li>
              <strong>Transaction Data:</strong> Payment history, referral
              activity, commission records
            </li>
            <li>
              <strong>Cookies:</strong> Session tokens, user preferences
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p>
            If Trading DZ is involved in a merger, acquisition, or asset sale,
            your personal data may be transferred as part of that transaction.
            We will provide notice before your personal data becomes subject to
            a different privacy policy.
          </p>
          <h3>Disclosure by Law</h3>
          <p>
            Trading DZ may disclose your personal data in good faith when
        ...
        <section>
          <h2>6. Cookies</h2>
          <p>
            We use cookies to enhance your experience with our Service. You have
            the option to disable cookies through your browser settings, but
            this may impact your ability to use certain features of the Service.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            We have no control over the practices of third-party websites and
        ...
        <section>
          ...
          <p>
            Our Service is not intended for anyone under the age of 18. We do
            not knowingly collect personally identifiable information from
            children under 18. If we become aware that a child under 18 has
            provided us with personal information, we immediately delete such
        ...
        <section>
          ...
          <p>
            <strong>Email:</strong> privacy@tradingdz.com
            <br />
            <strong>Telegram:</strong> @TradingDZSupport
            <br />
        ...
        <section>
          ...
          <p>
            ...
            You can request deletion of your data at any time, subject to legal
