    ...
    <div className='home-page'>
      ...
      <section className='hero'>
        <div className='hero-content'>
          ...
          <p className='hero-description'>
            Join our exclusive affiliate program and start generating passive
            income through multi-level commissions and referral rewards.
          </p>
        ...
        <div className='hero-visual'>
          <div className='gradient-circle circle-1' />
          <div className='gradient-circle circle-2' />
          <div className='gradient-circle circle-3' />
        </div>
      </section>
      ...
      <section className='why-choose'>
        ...
        <div className='features-grid'>
          <div className='feature-card'>
            ...
            <p>
              Earn from 5 levels of referrals with decreasing commission rates
            </p>
          </div>
      ...
      <section className='commission-section'>
        ...
        <p className='section-subtitle'>
          Earn from your network across 5 levels
        </p>
      ...
      <section className='faq-section'>
        ...
        <div className='faq-grid'>
          <div className='faq-item'>
            ...
            <p>
              The subscription fee is 250 USDT, which is a one-time payment to
          ...
          <div className='faq-item'>
            ...
            <p>
              Commissions are calculated based on the subscription fees paid by
              your referrals. You earn a percentage based on which level they
              are in your network.
            </p>
          </div>
          ...
          <div className='faq-item'>
            ...
            <p>
              You can withdraw your earnings anytime once you reach the minimum
              withdrawal amount. Most withdrawals are processed within 24 hours.
            </p>
          </div>
          ...
          <div className='faq-item'>
            ...
            <p>
              Yes, we are a fully registered affiliate marketing platform with
              transparent tracking and verified blockchain transactions.
            </p>
          </div>
          ...
          <div className='faq-item'>
            ...
            <p>
              Our support team is available 24/7 via email and our exclusive
              Telegram channel. You'll also get updates and trading tips daily.
            </p>
          </div>
          ...
          <div className='faq-item'>
            ...
            <p>
              Refunds are available within 7 days of subscription. After that,
              your subscription is non-refundable as per our terms.
            </p>
          </div>
        </div>
      </section>
