...
import { Send, AlertCircle, Check, Users, TrendingUp, Wallet, Clock, Copy, X } from 'lucide-react';
        ...
        <div className="stats-grid">
          ...
          <div className="stat-card referrals-card">
            ...
            <div className="stat-content">
              ...
              <span className="stat-value">{withdrawalData?.referralsCount || 0}</span>
          ...
          <div className="stat-card earnings-card">
            ...
            <div className="stat-content">
              ...
              <span className="stat-value">${withdrawalData?.totalEarnings || 0}</span>
        ...
        {(withdrawalData?.totalEarnings || 0) === 0 && (
          <div className="alert alert-info">
            ...
            <div className="alert-content">
              ...
              <p>ابدأ في إحضار أصدقاءك وأحبائك للانضمام وابدأ في كسب الأرباح!</p>
            </div>
          </div>
        )}
            ...
            <form onSubmit={handleWithdrawalRequest} className="withdrawal-form">
              ...
              <div className="withdrawal-summary">
                <div className="summary-item">
                  ...
                  <strong className="amount">${withdrawalData?.totalEarnings || 0}</strong>
                </div>
                <div className="summary-item">
                ...
                <div className="summary-item total">
                  ...
                  <strong className="total-amount">${withdrawalData?.totalEarnings || 0} USDT</strong>
                </div>
              </div>
                ...
                <div key={idx} className="request-row">
                  <div className="request-info">
                    ...
                    <div className="request-details">
                      ...
                      <small>{new Date(req.requestedAt).toLocaleDateString('ar-EG')}</small>
                    </div>
                  </div>
                  <div 
          ...
          <div className="modal-overlay">
            <div className="modal-content">
              ...
              <div className="modal-body">
                ...
                <form onSubmit={handleModalSubmit} className="withdrawal-modal-form">
                  <div className="form-group">
