      ...
      <section className='referral-link-section'>
        ...
        <div className='link-card'>
          ...
          <p className='link-hint'>
            Share this unique link with your friends and earn commissions
          </p>
                ...
                {referrals.map((ref) => (
                  <div key={ref.id} className='table-row'>
                    ...
                    <div className='col-status'>
                      <span
                        className={`status-badge ${ref.status?.toLowerCase() || 'pending'}`}
                      >
                        {ref.status || 'Pending'}
                      </span>
                    </div>
        ...
        <div className='tree-card'>
          ...
          <div className='tree-item level-3'>
            ...
            <p className='tree-count'>
              {(stats.totalReferrals || 0) - (stats.directReferrals || 0)}{' '}
              members
            </p>
          </div>
        </div>
