              ...
              {step === 1 && (
                <div className="step-content">
                  <div className="payment-info">
                    ...
                    <p className="amount-description">One-time payment for lifetime access</p>
                  </div>
                  ...
                  <div className="payment-method">
                    ...
                    <div className="method-option selected">
                      ...
                      <label htmlFor="binance">
                        <span className="method-name">Binance (Recommended)</span>
                  ...
                  <div className="wallet-details">
                    ...
                    <div className="wallet-address-box">
                      <p className="label">Wallet Address (ERC20/TRC20/BEP20):</p>
                    ...
                    <div className="amount-to-send">
                      ...
                      <div className="amount-box">
                        <span className="amount">{SUBSCRIPTION_AMOUNT} USDT</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="payment-instructions">
                    <h4>Instructions:</h4>
                    <ol>
                      <li>Send exactly <strong>{SUBSCRIPTION_AMOUNT} USDT</strong> to the wallet address above</li>
                      <li>You can use Binance or any other exchange that supports USDT transfers</li>
                      <li>Wait for the transaction to complete</li>
                      <li>Copy your transaction ID (TXID) and submit it in the next step</li>
                    </ol>
                  </div>
                ...
                <div className="step-content">
                  ...
                  <form onSubmit={handleSubmitPayment} className="payment-form">
                    <div className="form-group">
                      ...
                      <p className="form-hint">Enter the transaction hash/ID from your USDT transfer</p>
                      <input
                        type="text"
                        value={txId}
                    ...
                    <div className="confirmation-checklist">
                      ...
                      <label>
                        ...
                        I have sent {SUBSCRIPTION_AMOUNT} USDT to the wallet address
                      </label>
                      <label>
                        <input type="checkbox" required disabled={loading} />
                        I have copied the correct transaction ID
                      </label>
                      <label>
                        <input type="checkbox" required disabled={loading} />
                  ...
                  <div className="payment-note">
                    <Zap size={16} />
                    <p>Your payment will be verified within 24 hours. You'll receive confirmation via email.</p>
                  </div>
                </div>
              )}
            </>
