    ...
    <div className='payment-page'>
      <div className='payment-container'>
        ...
        <p className='page-subtitle'>
          ادفع 25 USDT للحصول على الوصول إلى القناة الحصرية على Telegram
        </p>
        ...
        {step === 1 && walletInfo && (
          <div className='payment-card step-card'>
            ...
            <div className='wallet-info'>
              ...
              <div className='info-item'>
                ...
                <div className='wallet-address-box'>
                  <a
                    href='https://s.binance.com/PB0rA7lm'
                    target='_blank'
            ...
            <div className='instructions-box'>
              ...
              <ol>
                <li>
                  اضغط على الرابط أعلاه للدفع عبر <strong>Binance Pay</strong>
                </li>
                <li>أو قم بمسح رمز QR إذا كنت تستخدم جهازاً آخر</li>
                <li>
                  أكمل عملية الدفع بقيمة <strong>25 USDT</strong>
                </li>
                <li>
                  بعد إتمام الدفع، انسخ معرّف المعاملة (Transaction ID / Order
                  ID)
                </li>
            ...
            <div className='success-details'>
              ...
              <div className='benefits-list'>
                ...
                <ul>
                  ...
                  <li>
                    ✅ الوصول إلى قناة Telegram الحصرية:{' '}
                    <strong>@trading_dz_vip</strong>
                  </li>
              ...
              <div className='telegram-link'>
                ...
                <a
                  href='https://t.me/trading_dz_vip'
                  target='_blank'
                  rel='noopener noreferrer'
                >
              ...
              <p className='redirect-text'>
                سيتم تحويلك إلى لوحة التحكم تلقائياً...
              </p>
            </div>
          </div>
        )}
